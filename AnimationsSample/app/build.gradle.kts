...
android {
  namespace = "com.meta.spatial.samples.animationssample"
  compileSdk = 34

  defaultConfig {
    applicationId = "com.meta.spatial.samples.animationssample"
    minSdk = 28
...
spatial {
  ...
  scenes {
    ...
    hotReload {
      appPackage.set("com.meta.spatial.samples.animationssample")
      appMainActivity.set(".AnimationsSampleActivity")
