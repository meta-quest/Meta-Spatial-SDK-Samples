...
android {
  namespace = "com.meta.spatial.samples.featuredevsample"
  //noinspection GradleDependency
  compileSdk = 34

  defaultConfig {
    applicationId = "com.meta.spatial.samples.featuredevsample"
    minSdk = 34
...
dependencies {
  ...
  // Native feature module - demonstrates SpatialFeature with JNI
  implementation(project(":nativefeature"))

  // Kotlin feature module - demonstrates SpatialFeature without native code
...
spatial {
  ...
  scenes {
    ...
    hotReload {
      appPackage.set("com.meta.spatial.samples.featuredevsample")
      appMainActivity.set(".FeatureDevSampleActivity")
