...
android {
  namespace = "com.meta.spatial.samples.uisetsample"
  //noinspection GradleDependency
  compileSdk = 34

  defaultConfig {
    applicationId = "com.meta.spatial.samples.uisetsample"
    minSdk = 34
...
spatial {
  ...
  scenes {
    ...
    hotReload {
      appPackage.set("hotReloadPackageName")
      appMainActivity.set(".hotReloadActivityName")
