...
android {
  namespace = "com.meta.spatial.samples.bodytrackingsample"
  //noinspection GradleDependency
  compileSdk = 34

  defaultConfig {
    applicationId = "com.meta.spatial.samples.bodytrackingsample"
    minSdk = 34
...
spatial {
  ...
  scenes {
    hotReload {
      appPackage.set("com.meta.spatial.samples.bodytrackingsample")
      appMainActivity.set(".BodyTrackingSampleActivity")
