...
android {
  namespace = "com.meta.spatial.samples.physicssample"
  compileSdk = 34

  defaultConfig {
    applicationId = "com.meta.spatial.samples.physicssample"
    minSdk = 28
...
spatial {
  ...
  scenes {
    ...
    hotReload {
      appPackage.set("com.meta.spatial.samples.physicssample")
