...
dependencies {
  ...
  implementation(files("libs/meta-spatial-sdk-0.7.1.aar"))
  implementation(files("libs/meta-spatial-sdk-ovrmetrics-0.7.1.aar"))
  implementation(files("libs/meta-spatial-sdk-physics-0.7.1.aar"))
  implementation(files("libs/meta-spatial-sdk-toolkit-0.7.1.aar"))
  implementation(files("libs/meta-spatial-sdk-vr-0.7.1.aar"))
  implementation(files("libs/meta-spatial-sdk-mruk-0.7.1.aar"))
  implementation(files("libs/meta-spatial-sdk-castinputforward-0.7.1.aar"))
  implementation(files("libs/meta-spatial-sdk-animation-0.7.1.aar"))
  implementation(files("libs/meta-spatial-sdk-compose-0.7.1.aar"))
  implementation(files("libs/meta-spatial-sdk-datamodelinspector-0.7.1.aar"))
  implementation(files("libs/meta-spatial-sdk-hotreload-0.7.1.aar"))
  implementation(files("libs/meta-spatial-sdk-isdk-0.7.1.aar"))
  implementation(files("libs/meta-spatial-sdk-spatialaudio-0.7.1.aar"))
  implementation(files("libs/meta-spatial-sdk-uiset-0.7.1.aar"))
