...
object FocusColors {
  val panel =
      Brush.verticalGradient(
          colors = listOf(Color(0xFFFFFFFF), Color(0xFFF2F1FF)),
      )
  val dialog =
      Brush.verticalGradient(
          colors = listOf(Color(0xFFFFFFFF), Color(0xFF0FC71B)),
      )
    ...
    colorScheme =
        lightSpatialColorScheme()
            .copy(
                ...
                secondaryAlphaBackground =
                    FocusColors.darkGray, // EditTextField & TextTileButton label
