...
class ImmersiveActivity : AppSystemActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    AudioManager.instance.ambientSoundPlayer =
        SceneAudioPlayer(scene, AudioManager.instance.ambientSound)
  }
  ...
  override fun onPause() {
    ...
    if (currentProject != null && AudioManager.instance.audioIsOn)
  ...
  fun setInitialState() {
    ...
    if (!PanelManager.instance.homePanel.getComponent<Visible>().isVisible)
        placeInFront(PanelManager.instance.homePanel)
  ...
  companion object {
    ...
    fun getInstance(): ImmersiveActivity? = if (::instance.isInitialized) instance.get() else null
  }
}
